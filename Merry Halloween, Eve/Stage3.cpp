...
void Stage3::Set()
{
	...
	m_Object[3].Set(L"호박블랭크.png");
	m_Object[4].Set(L"박쥐블랭크.png");
	m_Object[5].Set(L"해골블랭크.png");
	m_Object[6].Set(L"호박블랭크.png");
	...
	m_Object[0].set_x(2000);
	m_Object[0].set_y(10);
	m_Object[1].set_x(2400);
	m_Object[1].set_y(-150);
	m_Object[2].set_x(1900);
	m_Object[2].set_y(100);
	m_Object[3].set_x(1900);
	m_Object[3].set_y(-250);
	m_Object[4].set_x(2100);
	m_Object[4].set_y(-50);
	m_Object[5].set_x(2300);
	m_Object[5].set_y(-150);
	m_Object[6].set_x(2200);
	m_Object[6].set_y(100);
	...
	map_object_rect[3].left = m_Object[3].get_X() / 10 + map_rect.left;
	map_object_rect[3].right = map_object_rect[3].left + m_Object[3].getWidth() / 10;
	map_object_rect[3].top = map_rect.bottom - 80 + m_Object[3].get_Y() / 10;
	map_object_rect[3].bottom = map_object_rect[3].top + m_Object[3].getHeight() / 10;

	map_object_rect[4].left = m_Object[4].get_X() / 10 + map_rect.left;
	map_object_rect[4].right = map_object_rect[4].left + m_Object[4].getWidth() / 10;
	map_object_rect[4].top = map_rect.bottom - 80 + m_Object[4].get_Y() / 10;
	map_object_rect[4].bottom = map_object_rect[4].top + m_Object[4].getHeight() / 10;


	map_object_rect[5].left = m_Object[5].get_X() / 10 + map_rect.left;
	map_object_rect[5].right = map_object_rect[5].left + m_Object[5].getWidth() / 10;
	map_object_rect[5].top = map_rect.bottom - 80 + m_Object[5].get_Y() / 10;
	map_object_rect[5].bottom = map_object_rect[5].top + m_Object[5].getHeight() / 10;


	map_object_rect[6].left = m_Object[6].get_X() / 10 + map_rect.left;
	map_object_rect[6].right = map_object_rect[6].left + m_Object[6].getWidth() / 10;
	map_object_rect[6].top = map_rect.bottom - 80 + m_Object[6].get_Y() / 10;
	map_object_rect[6].bottom = map_object_rect[6].top + m_Object[6].getHeight() / 10;
...
void Stage3::Draw(HDC hDC)
{
	...
	for (int i = 0; i < 7; i++)
	{
		...
		else
		{
			//if (!m_bView)
			//{
			m_Item[i % 3].Draw(hDC, m_Object[i].get_X(), m_Object[i].get_Y());
			//}
		}
	}
...
void Stage3::Camera_Move_X(int num)
{
	//여기서 1200은 클라이언트 가로
...
void Stage3::Camera_Move_Y(int num)
{
	//여기서 800은 클라이언트 세로
	//예외처리
...
void Stage3::Mouse_Down(LPARAM lParam)
{
	if (m_bView) return;
	if (m_bThrow) return;
...
void Stage3::Mouse_Move(LPARAM lParam)
{
...
void Stage3::Keyboard_Down(WPARAM wParam)
{
	switch (wParam)
	{
	case VK_SPACE:
...
int Stage3::Check_Game_End()
{
	if (Heart_Num == 0)
		return 2;
	else if (Object_State[0] == 1 && Object_State[1] == 1 && Object_State[2] == 1
		&& Object_State[3] == 1 && Object_State[4] == 1
		&& Object_State[5] == 1 && Object_State[6] == 1)
		return 1;
}
